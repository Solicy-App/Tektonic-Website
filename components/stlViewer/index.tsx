					...
					try {
						...
						if (intersectsGroup.length > 0) {
							...
							loader.load(activeWing.path, (geometry) => {
								...
								//possitions
								if (activeWing?.movedPos.x) wingModelMesh.position.x += activeWing.movedPos.x;
								if (activeWing?.movedPos.y) wingModelMesh.position.y += activeWing.movedPos.y;
								if (activeWing?.movedPos.z) wingModelMesh.position.z += activeWing.movedPos.z;
